  ...
  if ($current_entity && isset($current_entity->type)) {
    ...
    switch ($current_entity->type) {
      ...
      case 'news':
        ...
        break;
      case 'team':
        drupal_add_js(THEME_PATH . '/js/components/bio.js', array('scope' => 'header', 'group' => JS_THEME, 'weight' => 2));
        drupal_add_css(THEME_PATH . '/css/components/bio/bio.min.css', array('group' => CSS_THEME));
        break;
      default:
