...
var components = ['header', 'mobile-menu', 'hero', 'featured-content', 'resources', 'profile', 'solutions', 'reviews', 'accordion', 'split-content', 'documents', 'articles', 'locations', 'team', 'tools', 'form', 'main-content', 'video', 'footer'];
